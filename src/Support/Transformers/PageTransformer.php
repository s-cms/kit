...
class PageTransformer
{
    ...
    public static function transform($page, array $options = []): array
    {
        ...
        $data = [
            ...
            'image' => MediaResource::make($page->image)->toArray(request()),
            'banner' => MediaResource::make($page->banner)->toArray(request()),
            'title' => $page->title,
            ...
            'meta' => $page->meta ?? [],
            'tags' => $page->tags->where('type', 'tag')->pluck('name')->toArray(),
        ];
